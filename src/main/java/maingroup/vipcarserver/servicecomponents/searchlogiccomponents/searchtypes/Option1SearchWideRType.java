...
public class Option1SearchWideRType {
    ...
    public FoundDriverDto searchClosestFitDriver(Long userId, SearchRiderDataDto riderData) {
        ...
        BiFunction<Double, Double, List<SearchFitDriversDataDto>> searchFunction = driverRepository::findDriversWithOption1WideRadiusWithoutParam1;
