...
public class Option1SearchWideRadiusType {
    ...
    public FoundDriverDto searchClosestFitDriver(Long userId, SearchRiderDataDto riderData) {
        ...
        BiFunction<Double, Double, List<SearchFitDriversDataDto>> searchFunction = driverRepository::findDriversWithOption1WRadius;
